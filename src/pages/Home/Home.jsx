        ...
        <>
            ...
            <section
                className={`main-section relative ${
                    isModalShow ? "h-[100vh] overflow-y-hidden" : "min-h-screen "
                }`}>
                <Header />
                <SectionLeft />
                    ...
                    <div className="post-block flex flex-col gap-4">
                        {postList.map((item, index) => {
                            return (
                                <div
                                    key={index}
                                    className="post bg-white rounded-md p-4 border border-gray-200 shadow-md">
                                    <div className="container">
                                        ...
                                        <div className="content my-3">
                                            ...
                                            <div className="media mt-3">
                                                <img src={item.media} alt="post-image" />
                                            </div>
                                        </div>
                                        <div className="footer flex flex-col">
                                            <div className="reaction-comment-count flex justify-between">
                                                <div className="reactions flex gap-2 text-gray-700">
                                                    ...
                                                    <p>You and 120 others</p>
                                                </div>
                                                <div className="comments text-gray-700">
                                                    <p className="text-gray-700">89 comments</p>
                                                </div>
                                            </div>
                                            <Divider />
                                            <div className="action-button-group">
                                                <div className="actions_bottom">
                                                    <ul className="flex">
                                                        <li className="flex items-center hover:bg-gray-200 flex-1 justify-center text-gray-700 gap-1 text-[18px] rounded-md cursor-pointer py-1">
