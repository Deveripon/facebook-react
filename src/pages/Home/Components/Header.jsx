        ...
        <header className="bg-white shadow-lg sticky w-full  top-[0px] z-[9999]">
            <nav className="home-menu flex px-5 justify-between items-center">
                <div className="branding-with-search flex justify-start gap-3">
                    ...
                    <div className="search-field flex justify-start items-center border p-2 rounded-full bg-gray-100">
                        <IoIosSearch />
                        <input
                            className="bg-transparent outline-none border-none mx-3"
                            type="search"
                            name="search"
                            id="search"
                ...
                <div className="nav-items-list">
                    <ul className="flex justify-between items-center gap-3">
                        <li
                            title="Home"
                            className="w-[110px] transform duration-150 flex justify-center py-[13px]  bg-white rounded-none border-b-4  border-primary">
                            <a href="#" className=" relative my-1">
                                <svg
                            ...
                            {/* <span className="absolute bottom-[-45px] bg-[rgba(0,0,0,.7)] text-[14px] leading-[20px] px-3 py-[7px] rounded-xl text-white">
                        Home
                    </span> */}
                        </li>
                        <li
                            title="Home"
                            className="w-[110px] transform duration-150 hover:bg-gray-200 flex justify-center py-[13px] rounded-md">
                            <a href="#">
                                <svg
                                    viewBox="0 0 24 24"
                                    width="24"
                        ...
                        <li className="w-[110px] transform duration-150 hover:bg-gray-200 flex justify-center py-[13px] rounded-md">
                            <a href="#" title="Gaming">
                                <svg
                                    viewBox="0 0 24 24"
                                    width="24"
                ...
                <div className="dashboard-buttons-list">
                    <ul className="flex justify-between items-center gap-2">
                        <li className="transform duration-150 bg-gray-200 flex justify-center p-3  rounded-full">
                            <a href="#" title="Menu">
                                <svg
                                    viewBox="0 0 24 24"
                                    width="20"
